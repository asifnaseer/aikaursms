...
<head>
	...
	<link href="{{ asset('public/layouts/metronic/front/assets/css/pages/error.css') }}" rel="stylesheet" type="text/css"/>
...
<body class="page-404-full-page">
	...
	<!-- BEGIN CORE PLUGINS -->   <script src="{{ asset('public/layouts/metronic/front/assets/plugins/jquery-1.10.1.min.js') }}" type="text/javascript"></script>
