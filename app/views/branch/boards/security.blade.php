...
@section('styles')
    ...
    <link href="{{ asset('public/layouts/metronic/front/assets/plugins/jquery-multi-select/css/multi-select-metro.css') }}" rel="stylesheet" type="text/css" media="screen"/>
    ...
    <div class="container-fluid">
            ...
            <div class="row-fluid">
                    <div class="portlet-body">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                {{ Form::open(array('id'=>'security_form', 'class' => 'horizontal-form')) }}
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('public/layouts/metronic/front/assets/plugins/jquery-multi-select/js/jquery.multi-select.js') }}" type="text/javascript"></script>
    <script type="text/javascript">
        jQuery(document).ready(function() {
            ...
            $('#i_m_done').bind('click',function(event){
                ...
                $.post("{{ URL::Route('user.add.board.setting')}}",form_data,function(data){
                    if(data.success == true){
                        toastr.success('<p>Preset added successfully!</p>', 'Success!');    
                        location = "{{url('/user/new-board/5/'.$id.'/'.$board_id)}}";
                    }
                });
            });
